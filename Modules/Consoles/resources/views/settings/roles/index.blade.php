        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Rôles <span class="text-primary  total_count">0</span> </li>
                </ol>
            </nav>
        </div>
     {{--   &nbsp; <h6 class="mb-0 text-uppercase">DataTable Example</h6>--}}
        <div class="ms-auto">
            <button type="button" onclick="loadModal('{{route('consoles.settings.roles.form')}}','{{json_encode([])}}','FORMULAIRE DE ROLE')" class="btn btn-primary"> <i class="bx bx-plus"></i> Nouveau</button>
        </div>
    </div>
  ...
  {{--  <script src="{{asset('select2-v4_1/select2.full.min.js')}}" defer></script>--}}
    <script>
                    ...
                    .then((response) => {
                     ...
                     /*       Swal.fire({
                               ...
                               rgba(60,60,60,0.8)`,
                                ...
                                cancelButtonAriaLabel: 'Thumbs down, Ok',
                                timer: 3000
                            })*/
                            if(success){
                                toastS(re_message)
        ...
        function launchReloadDataTable() {
            ...
            table.destroy();
            route = '{{route('consoles.settings.roles.getall')}}';
            title = "Liste des rôles"
            columns =  ['name','permission','action'];
            postColumns =  ['l','c','c'];

<form action="{{route('consoles.settings.times.store')}}" method="POST" class="form_load">
    @csrf
    ...
    <div class="form-group">
        <label class="form-label" for="time">Durée Appel</label>
        <input type="text" class="form-control" name="time" id="time" value="{{$data?$data->time:''}}">
    </div>
